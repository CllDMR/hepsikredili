...
import { ApiMainAccountCorporateService } from './account.service';

describe('ApiMainAccountCorporateService', () => {
  let service: ApiMainAccountCorporateService;
  ...
  beforeAll(async () => {
    ...
    service = module.get<ApiMainAccountCorporateService>(
