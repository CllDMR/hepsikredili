...
import { ApiMainAccountIndividualService } from './account.service';

describe('ApiMainAccountIndividualService', () => {
  let service: ApiMainAccountIndividualService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<ApiMainAccountIndividualService>(
