...
export const Menu: FC<MenuProps> = ({ firstname, lastname }) => {
  ...
  return (
    <HUMenu as="div" className="relative">
      <HUMenu.Button className="inline-flex items-center justify-between w-full px-3 py-2 text-gray-600 border border-gray-300 border-solid rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-opacity-75">
